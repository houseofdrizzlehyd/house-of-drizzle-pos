...
export function AdminReportsClient() {
  ...
  function exportCsv() {
    ...
    const rows = [
      ...
      ["Delivery charges collected (Rs)", report.deliveryChargesCollected.toFixed(2)],
    ...
    <div className="p-3 sm:p-6">
      ...
      {!report ? (
        ...
        <>
          ...
          {report.deliveryChargesCollected > 0 && (
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
              <Metric label="Delivery charges collected" value={`Rs ${report.deliveryChargesCollected.toFixed(0)}`} />
            </div>
          )}
